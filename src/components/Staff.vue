                    ...
                    <div class="col-6 d-flex justify-content-end flex-column">
                        ...
                        <div class="d-flex mt-2">
                            <span class="d-flex justify-content-center align-items-center">
                                <img :src="require(`../assets/images/${element.social_1}`)" alt="Teacher">
                            </span>
                            <span class="d-flex justify-content-center align-items-center">
                                <img :src="require(`../assets/images/${element.social_2}`)" alt="Teacher">
                            </span>
                            <span class="d-flex justify-content-center align-items-center">
                                <img :src="require(`../assets/images/${element.social_3}`)" alt="Teacher">
                            </span>
...
<script>
import StaffList from "@/DevData/StaffList.js";
export default {
name: 'Staff',
data(){
    return{
